...
THEME = 'テーマ：'
# THEMELIST = ['男性用ズボンを改善するアイデア','新しい冷蔵庫の機能とデザインのアイデア','新しい洗濯機の機能とデザインのアイデア']
# THEMELIST = ['傘の使いみち','ビール瓶の使いみち','ハンガーの使いみち','ほうきの使いみち','レンガの使いみち','お隣の犬があなたのお気に入りのチューリップ畑を近道として通っている。これをやめさせるためのアイデアを考えよ。']
THEMELIST = ['ほうきの使いみちをできるだけたくさん考えよ','傘の使いみちをできるだけたくさん考えよ','空になったビールびんの使いみちをできるだけたくさん考えよ']
